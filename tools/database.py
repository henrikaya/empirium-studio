...
def insertAllDatas(datas, name, cycle, id_request, db_host, db_port):
    ...
    EQU_MATRIX['frg_20.gif'] = "Croiseur d'invasion"
    EQU_MATRIX['frg_22.gif'] = "Croiseur espion"
    EQU_MATRIX['frg_23.gif'] = "Croiseur solo"
    EQU_MATRIX['frg_26.gif'] = "Croiseur nexus"
    EQU_MATRIX['frg_27.gif'] = "Croiseur marchand"
    EQU_MATRIX['frg_28.gif'] = "Croiseur de soutien"
    EQU_MATRIX['frg_29.gif'] = "Croiseur hypertransport"
    EQU_MATRIX['frg_32.gif'] = "Croiseur bloqueur"
